...
export const feedbackAnalysisPrompt: PromptTemplate = {
...
export const bugAnalysisPrompt: PromptTemplate = {
...
export const featureRequestPrompt: PromptTemplate = {
...
export const sentimentAnalysisPrompt: PromptTemplate = {
